...
for(const file of ['index.html','styles.css','app-extra.css','feedback.css','regional-audio.css','app.js','core.js','data.js','regional-audio.js','.nojekyll'])fs.copyFileSync(path.join(root,file),path.join(out,file));
